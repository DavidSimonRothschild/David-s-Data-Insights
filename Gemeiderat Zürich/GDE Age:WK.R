...
# 06
mean_age_bar_plot06 <- ggplot(mean_age_by_gender_and_party06, aes(x = Wahlkreis, y = mean_age, fill = G)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_hline(yintercept = 43, color = "red", linetype = "dashed", size = 1)+
  labs(
    title = "Durchschnittsalter nach Wahlkreis und Geschlecht \n (Wahlen 2006)",
    x = "Wahlkreis",
...
mean_age_bar_plot10 <- ggplot(mean_age_by_gender_and_party10, aes(x = Wahlkreis, y = mean_age, fill = G)) +
  geom_bar(stat = "identity", position = "dodge") +
...
mean_age_bar_plot14 <- ggplot(mean_age_by_gender_and_party14, aes(x = Wahlkreis, y = mean_age, fill = G)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_hline(yintercept = 45, color = "red", linetype = "dashed", size = 1)+
  labs(
    title = "Durchschnittsalter nach Wahlkreis und Geschlecht \n (Wahlen 2014)",
...
mean_age_bar_plot18 <- ggplot(mean_age_by_gender_and_party18, aes(x = Wahlkreis, y = mean_age, fill = G)) +
  geom_bar(stat = "identity", position = "dodge") +
...
mean_age_bar_plot22 <- ggplot(mean_age_by_gender_and_party22, aes(x = Wahlkreis, y = mean_age, fill = G)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_hline(yintercept = 46, color = "red", linetype = "dashed", size = 1) +
  labs(
    title = "Durchschnittsalter nach Wahlkreis und Geschlecht \n (Wahlen 2022)",
